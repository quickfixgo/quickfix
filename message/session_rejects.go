...
func NewInvalidTagNumber(msg Message, tag fix.Tag) MessageReject {
...
func NewTagNotDefinedForThisMessageType(msg Message, tag fix.Tag) MessageReject {
...
func NewRequiredTagMissing(msg Message, tag fix.Tag) MessageReject {
...
func NewTagSpecifiedWithoutAValue(msg Message, tag fix.Tag) MessageReject {
...
func NewValueIsIncorrect(msg Message, tag *fix.Tag) MessageReject {
...
func NewIncorrectDataFormatForValue(msg Message, tag fix.Tag) MessageReject {
...
func NewTagSpecifiedOutOfRequiredOrder(msg Message, tag fix.Tag) MessageReject {
...
func NewTagAppearsMoreThanOnce(msg Message, tag fix.Tag) MessageReject {
...
func NewIncorrectNumInGroupCountForRepeatingGroup(msg Message, tag fix.Tag) MessageReject {
