...
func (m OrderCancelRequest) SolicitedFlag() (*field.SolicitedFlagField, errors.MessageRejectError) {
...
func (m OrderCancelRequest) GetSolicitedFlag(f *field.SolicitedFlagField) errors.MessageRejectError {
	return m.Body.Get(f)
}
