...
func (m OrderCancelRequest) SolicitedFlag() (*field.SolicitedFlag, errors.MessageRejectError) {
...
func (m OrderCancelRequest) GetSolicitedFlag(f *field.SolicitedFlag) errors.MessageRejectError {
	return m.Body.Get(f)
}
