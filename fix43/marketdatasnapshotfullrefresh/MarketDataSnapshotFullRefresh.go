...
func (m Message) TotalVolumeTradedDate() (*field.TotalVolumeTradedDateField, errors.MessageRejectError) {
...
func (m Message) GetTotalVolumeTradedDate(f *field.TotalVolumeTradedDateField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//TotalVolumeTradedTime is a non-required field for MarketDataSnapshotFullRefresh.
func (m Message) TotalVolumeTradedTime() (*field.TotalVolumeTradedTimeField, errors.MessageRejectError) {
...
func (m Message) GetTotalVolumeTradedTime(f *field.TotalVolumeTradedTimeField) errors.MessageRejectError {
	return m.Body.Get(f)
}
