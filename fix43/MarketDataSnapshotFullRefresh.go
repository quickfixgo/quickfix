...
func (m MarketDataSnapshotFullRefresh) GetTotalVolumeTradedDate(f *field.TotalVolumeTradedDate) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m MarketDataSnapshotFullRefresh) GetTotalVolumeTradedTime(f *field.TotalVolumeTradedTime) errors.MessageRejectError {
	return m.Body.Get(f)
}
