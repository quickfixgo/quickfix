...
//New returns an initialized MultilegOrderCancelReplaceRequest instance
func New(origclordid string, clordid string, handlinst string, side string, instrument instrument.Instrument, nolegs []NoLegs, transacttime time.Time, orderqtydata orderqtydata.OrderQtyData, ordtype string) *Message {
	var m Message
