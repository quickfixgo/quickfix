...
func (m BidRequest) TotalNumSecurities() (*field.TotalNumSecuritiesField, errors.MessageRejectError) {
...
func (m BidRequest) GetTotalNumSecurities(f *field.TotalNumSecuritiesField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m BidRequest) TradeType() (*field.TradeTypeField, errors.MessageRejectError) {
...
func (m BidRequest) GetTradeType(f *field.TradeTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}
