...
func (m Message) TotalNumSecurityTypes() (*field.TotalNumSecurityTypesField, errors.MessageRejectError) {
...
func (m Message) GetTotalNumSecurityTypes(f *field.TotalNumSecurityTypesField) errors.MessageRejectError {
	return m.Body.Get(f)
}
