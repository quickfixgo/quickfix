...
func (m *NewOrderMultileg) SettlmntTyp() (*field.SettlmntTyp, error) {
...
func (m *NewOrderMultileg) QuantityType() (*field.QuantityType, error) {
...
func (m *NewOrderMultileg) DiscretionOffset() (*field.DiscretionOffset, error) {
...
func (m *NewOrderMultileg) FutSettDate() (*field.FutSettDate, error) {
...
func (m *NewOrderMultileg) NetMoney() (*field.NetMoney, error) {
...
func (m *NewOrderMultileg) PegDifference() (*field.PegDifference, error) {
