...
func (m Message) OpenCloseSettleFlag() (*field.OpenCloseSettleFlagField, quickfix.MessageRejectError) {
...
func (m Message) GetOpenCloseSettleFlag(f *field.OpenCloseSettleFlagField) quickfix.MessageRejectError {
	return m.Body.Get(f)
}
