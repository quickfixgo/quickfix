...
func (m Message) OpenCloseSettleFlag() (*field.OpenCloseSettleFlagField, errors.MessageRejectError) {
...
func (m Message) GetOpenCloseSettleFlag(f *field.OpenCloseSettleFlagField) errors.MessageRejectError {
	return m.Body.Get(f)
}
