...
func (m SecurityTypes) TotalNumSecurityTypes() (*field.TotalNumSecurityTypesField, errors.MessageRejectError) {
...
func (m SecurityTypes) GetTotalNumSecurityTypes(f *field.TotalNumSecurityTypesField) errors.MessageRejectError {
	return m.Body.Get(f)
}
