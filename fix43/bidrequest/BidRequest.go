...
func (m Message) TotalNumSecurities() (*field.TotalNumSecuritiesField, errors.MessageRejectError) {
...
func (m Message) GetTotalNumSecurities(f *field.TotalNumSecuritiesField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m Message) TradeType() (*field.TradeTypeField, errors.MessageRejectError) {
	f := &field.TradeTypeField{}
	err := m.Body.Get(f)
	return f, err
}

//GetTradeType reads a TradeType from BidRequest.
func (m Message) GetTradeType(f *field.TradeTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func Builder(
	...
	totalnumsecurities *field.TotalNumSecuritiesField,
...
func Route(router RouteOut) (string, string, quickfix.MessageRoute) {
	...
	return fix.BeginString_FIX43, "k", r
}
