...
func (m MarketDataRequest) OpenCloseSettleFlag() (*field.OpenCloseSettleFlagField, errors.MessageRejectError) {
	f := &field.OpenCloseSettleFlagField{}
	err := m.Body.Get(f)
	return f, err
}

//GetOpenCloseSettleFlag reads a OpenCloseSettleFlag from MarketDataRequest.
func (m MarketDataRequest) GetOpenCloseSettleFlag(f *field.OpenCloseSettleFlagField) errors.MessageRejectError {
	return m.Body.Get(f)
}
