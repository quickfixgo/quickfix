...
func (m Message) NoRateSources() (*field.NoRateSourcesField, quickfix.MessageRejectError) {
...
func (m Message) GetNoRateSources(f *field.NoRateSourcesField) quickfix.MessageRejectError {
	return m.Body.Get(f)
}
