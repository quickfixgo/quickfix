...
func (m ListStatus) SetContingencyType(v int) {
	m.Set(field.NewContingencyType(v))
}

//SetListRejectReason sets ListRejectReason, Tag 1386
func (m ListStatus) SetListRejectReason(v int) {
...
func (m ListStatus) GetLastFragment() (f field.LastFragmentField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetContingencyType gets ContingencyType, Tag 1385
func (m ListStatus) GetContingencyType() (f field.ContingencyTypeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetListRejectReason gets ListRejectReason, Tag 1386
func (m ListStatus) GetListRejectReason() (f field.ListRejectReasonField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
