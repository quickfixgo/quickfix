...
func (m Message) MDStreamID() (*field.MDStreamIDField, errors.MessageRejectError) {
...
func (m Message) GetMDStreamID(f *field.MDStreamIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}
