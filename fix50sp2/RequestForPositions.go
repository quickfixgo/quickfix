...
func (m RequestForPositions) SecurityGroup() (*field.SecurityGroupField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetSecurityGroup(f *field.SecurityGroupField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//MinPriceIncrementAmount is a non-required field for RequestForPositions.
func (m RequestForPositions) MinPriceIncrementAmount() (*field.MinPriceIncrementAmountField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetMinPriceIncrementAmount(f *field.MinPriceIncrementAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//UnitOfMeasureQty is a non-required field for RequestForPositions.
func (m RequestForPositions) UnitOfMeasureQty() (*field.UnitOfMeasureQtyField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetUnitOfMeasureQty(f *field.UnitOfMeasureQtyField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//SecurityXMLLen is a non-required field for RequestForPositions.
func (m RequestForPositions) SecurityXMLLen() (*field.SecurityXMLLenField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetSecurityXMLLen(f *field.SecurityXMLLenField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//SecurityXML is a non-required field for RequestForPositions.
func (m RequestForPositions) SecurityXML() (*field.SecurityXMLField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetSecurityXML(f *field.SecurityXMLField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//SecurityXMLSchema is a non-required field for RequestForPositions.
func (m RequestForPositions) SecurityXMLSchema() (*field.SecurityXMLSchemaField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetSecurityXMLSchema(f *field.SecurityXMLSchemaField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//ProductComplex is a non-required field for RequestForPositions.
func (m RequestForPositions) ProductComplex() (*field.ProductComplexField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetProductComplex(f *field.ProductComplexField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//PriceUnitOfMeasure is a non-required field for RequestForPositions.
func (m RequestForPositions) PriceUnitOfMeasure() (*field.PriceUnitOfMeasureField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetPriceUnitOfMeasure(f *field.PriceUnitOfMeasureField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//PriceUnitOfMeasureQty is a non-required field for RequestForPositions.
func (m RequestForPositions) PriceUnitOfMeasureQty() (*field.PriceUnitOfMeasureQtyField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetPriceUnitOfMeasureQty(f *field.PriceUnitOfMeasureQtyField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//SettlMethod is a non-required field for RequestForPositions.
func (m RequestForPositions) SettlMethod() (*field.SettlMethodField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetSettlMethod(f *field.SettlMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//ExerciseStyle is a non-required field for RequestForPositions.
func (m RequestForPositions) ExerciseStyle() (*field.ExerciseStyleField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetExerciseStyle(f *field.ExerciseStyleField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//OptPayoutAmount is a non-required field for RequestForPositions.
func (m RequestForPositions) OptPayoutAmount() (*field.OptPayoutAmountField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetOptPayoutAmount(f *field.OptPayoutAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//PriceQuoteMethod is a non-required field for RequestForPositions.
func (m RequestForPositions) PriceQuoteMethod() (*field.PriceQuoteMethodField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetPriceQuoteMethod(f *field.PriceQuoteMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//ListMethod is a non-required field for RequestForPositions.
func (m RequestForPositions) ListMethod() (*field.ListMethodField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetListMethod(f *field.ListMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//CapPrice is a non-required field for RequestForPositions.
func (m RequestForPositions) CapPrice() (*field.CapPriceField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetCapPrice(f *field.CapPriceField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//FloorPrice is a non-required field for RequestForPositions.
func (m RequestForPositions) FloorPrice() (*field.FloorPriceField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetFloorPrice(f *field.FloorPriceField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//PutOrCall is a non-required field for RequestForPositions.
func (m RequestForPositions) PutOrCall() (*field.PutOrCallField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetPutOrCall(f *field.PutOrCallField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//FlexibleIndicator is a non-required field for RequestForPositions.
func (m RequestForPositions) FlexibleIndicator() (*field.FlexibleIndicatorField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetFlexibleIndicator(f *field.FlexibleIndicatorField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//FlexProductEligibilityIndicator is a non-required field for RequestForPositions.
func (m RequestForPositions) FlexProductEligibilityIndicator() (*field.FlexProductEligibilityIndicatorField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetFlexProductEligibilityIndicator(f *field.FlexProductEligibilityIndicatorField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//ValuationMethod is a non-required field for RequestForPositions.
func (m RequestForPositions) ValuationMethod() (*field.ValuationMethodField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetValuationMethod(f *field.ValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//ContractMultiplierUnit is a non-required field for RequestForPositions.
func (m RequestForPositions) ContractMultiplierUnit() (*field.ContractMultiplierUnitField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetContractMultiplierUnit(f *field.ContractMultiplierUnitField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//FlowScheduleType is a non-required field for RequestForPositions.
func (m RequestForPositions) FlowScheduleType() (*field.FlowScheduleTypeField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetFlowScheduleType(f *field.FlowScheduleTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//RestructuringType is a non-required field for RequestForPositions.
func (m RequestForPositions) RestructuringType() (*field.RestructuringTypeField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetRestructuringType(f *field.RestructuringTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//Seniority is a non-required field for RequestForPositions.
func (m RequestForPositions) Seniority() (*field.SeniorityField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetSeniority(f *field.SeniorityField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//NotionalPercentageOutstanding is a non-required field for RequestForPositions.
func (m RequestForPositions) NotionalPercentageOutstanding() (*field.NotionalPercentageOutstandingField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetNotionalPercentageOutstanding(f *field.NotionalPercentageOutstandingField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//OriginalNotionalPercentageOutstanding is a non-required field for RequestForPositions.
func (m RequestForPositions) OriginalNotionalPercentageOutstanding() (*field.OriginalNotionalPercentageOutstandingField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetOriginalNotionalPercentageOutstanding(f *field.OriginalNotionalPercentageOutstandingField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//AttachmentPoint is a non-required field for RequestForPositions.
func (m RequestForPositions) AttachmentPoint() (*field.AttachmentPointField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetAttachmentPoint(f *field.AttachmentPointField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//DetachmentPoint is a non-required field for RequestForPositions.
func (m RequestForPositions) DetachmentPoint() (*field.DetachmentPointField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetDetachmentPoint(f *field.DetachmentPointField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//StrikePriceDeterminationMethod is a non-required field for RequestForPositions.
func (m RequestForPositions) StrikePriceDeterminationMethod() (*field.StrikePriceDeterminationMethodField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetStrikePriceDeterminationMethod(f *field.StrikePriceDeterminationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//StrikePriceBoundaryMethod is a non-required field for RequestForPositions.
func (m RequestForPositions) StrikePriceBoundaryMethod() (*field.StrikePriceBoundaryMethodField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetStrikePriceBoundaryMethod(f *field.StrikePriceBoundaryMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//StrikePriceBoundaryPrecision is a non-required field for RequestForPositions.
func (m RequestForPositions) StrikePriceBoundaryPrecision() (*field.StrikePriceBoundaryPrecisionField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetStrikePriceBoundaryPrecision(f *field.StrikePriceBoundaryPrecisionField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//UnderlyingPriceDeterminationMethod is a non-required field for RequestForPositions.
func (m RequestForPositions) UnderlyingPriceDeterminationMethod() (*field.UnderlyingPriceDeterminationMethodField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetUnderlyingPriceDeterminationMethod(f *field.UnderlyingPriceDeterminationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//OptPayoutType is a non-required field for RequestForPositions.
func (m RequestForPositions) OptPayoutType() (*field.OptPayoutTypeField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetOptPayoutType(f *field.OptPayoutTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//NoComplexEvents is a non-required field for RequestForPositions.
func (m RequestForPositions) NoComplexEvents() (*field.NoComplexEventsField, errors.MessageRejectError) {
...
func (m RequestForPositions) GetNoComplexEvents(f *field.NoComplexEventsField) errors.MessageRejectError {
	return m.Body.Get(f)
}
