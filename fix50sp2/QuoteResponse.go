...
func (m QuoteResponse) OptPayoutAmount() (field.OptPayoutAmount, error) {
...
func (m QuoteResponse) ValuationMethod() (field.ValuationMethod, error) {
...
func (m QuoteResponse) ContractMultiplierUnit() (field.ContractMultiplierUnit, error) {
...
func (m QuoteResponse) FlowScheduleType() (field.FlowScheduleType, error) {
...
func (m QuoteResponse) RestructuringType() (field.RestructuringType, error) {
...
func (m QuoteResponse) Seniority() (field.Seniority, error) {
...
func (m QuoteResponse) NotionalPercentageOutstanding() (field.NotionalPercentageOutstanding, error) {
...
func (m QuoteResponse) OriginalNotionalPercentageOutstanding() (field.OriginalNotionalPercentageOutstanding, error) {
...
func (m QuoteResponse) AttachmentPoint() (field.AttachmentPoint, error) {
...
func (m QuoteResponse) DetachmentPoint() (field.DetachmentPoint, error) {
...
func (m QuoteResponse) StrikePriceDeterminationMethod() (field.StrikePriceDeterminationMethod, error) {
...
func (m QuoteResponse) StrikePriceBoundaryMethod() (field.StrikePriceBoundaryMethod, error) {
...
func (m QuoteResponse) StrikePriceBoundaryPrecision() (field.StrikePriceBoundaryPrecision, error) {
...
func (m QuoteResponse) UnderlyingPriceDeterminationMethod() (field.UnderlyingPriceDeterminationMethod, error) {
...
func (m QuoteResponse) OptPayoutType() (field.OptPayoutType, error) {
...
func (m QuoteResponse) NoComplexEvents() (field.NoComplexEvents, error) {
