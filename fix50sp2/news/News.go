...
func (m News) SetNewsCategory(v int) {
...
func (m News) GetApplID() (f field.ApplIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetApplSeqNum gets ApplSeqNum, Tag 1181
func (m News) GetApplSeqNum() (f field.ApplSeqNumField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetMarketSegmentID gets MarketSegmentID, Tag 1300
func (m News) GetMarketSegmentID() (f field.MarketSegmentIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetMarketID gets MarketID, Tag 1301
func (m News) GetMarketID() (f field.MarketIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetApplLastSeqNum gets ApplLastSeqNum, Tag 1350
func (m News) GetApplLastSeqNum() (f field.ApplLastSeqNumField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetApplResendFlag gets ApplResendFlag, Tag 1352
func (m News) GetApplResendFlag() (f field.ApplResendFlagField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetNewsID gets NewsID, Tag 1472
func (m News) GetNewsID() (f field.NewsIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetNewsCategory gets NewsCategory, Tag 1473
func (m News) GetNewsCategory() (f field.NewsCategoryField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetLanguageCode gets LanguageCode, Tag 1474
func (m News) GetLanguageCode() (f field.LanguageCodeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NoLinesOfText) GetText() (f field.TextField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetEncodedTextLen gets EncodedTextLen, Tag 354
func (m NoLinesOfText) GetEncodedTextLen() (f field.EncodedTextLenField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetEncodedText gets EncodedText, Tag 355
func (m NoLinesOfText) GetEncodedText() (f field.EncodedTextField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NoNewsRefIDs) SetNewsRefType(v int) {
	m.Set(field.NewNewsRefType(v))
}

//GetNewsRefID gets NewsRefID, Tag 1476
func (m NoNewsRefIDs) GetNewsRefID() (f field.NewsRefIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetNewsRefType gets NewsRefType, Tag 1477
func (m NoNewsRefIDs) GetNewsRefType() (f field.NewsRefTypeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
