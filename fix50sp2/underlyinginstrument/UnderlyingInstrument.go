...
func (m *Component) SetUnderlyingContractMultiplierUnit(v int) {
	m.UnderlyingContractMultiplierUnit = &v
}
func (m *Component) SetUnderlyingFlowScheduleType(v int)     { m.UnderlyingFlowScheduleType = &v }
func (m *Component) SetUnderlyingRestructuringType(v string) { m.UnderlyingRestructuringType = &v }
func (m *Component) SetUnderlyingSeniority(v string)         { m.UnderlyingSeniority = &v }
func (m *Component) SetUnderlyingNotionalPercentageOutstanding(v float64) {
	m.UnderlyingNotionalPercentageOutstanding = &v
}
func (m *Component) SetUnderlyingOriginalNotionalPercentageOutstanding(v float64) {
	m.UnderlyingOriginalNotionalPercentageOutstanding = &v
}
func (m *Component) SetUnderlyingAttachmentPoint(v float64) { m.UnderlyingAttachmentPoint = &v }
func (m *Component) SetUnderlyingDetachmentPoint(v float64) { m.UnderlyingDetachmentPoint = &v }
