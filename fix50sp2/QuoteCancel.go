...
func (m QuoteCancel) QuoteType() (*field.QuoteTypeField, errors.MessageRejectError) {
...
func (m QuoteCancel) GetQuoteType(f *field.QuoteTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//NoTargetPartyIDs is a non-required field for QuoteCancel.
func (m QuoteCancel) NoTargetPartyIDs() (*field.NoTargetPartyIDsField, errors.MessageRejectError) {
...
func (m QuoteCancel) GetNoTargetPartyIDs(f *field.NoTargetPartyIDsField) errors.MessageRejectError {
	return m.Body.Get(f)
}
