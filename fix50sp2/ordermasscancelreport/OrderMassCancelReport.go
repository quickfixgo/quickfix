...
type Message struct {
	...
	//NotAffectedOrdersGrp is a non-required component for OrderMassCancelReport.
	...
	//TargetParties is a non-required component for OrderMassCancelReport.
...
func New(orderid string, masscancelrequesttype string, masscancelresponse string, massactionreportid string) *Message {
	var m Message
