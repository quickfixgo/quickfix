...
func (m Message) QuoteRespType() (*field.QuoteRespTypeField, quickfix.MessageRejectError) {
...
func (m Message) GetQuoteRespType(f *field.QuoteRespTypeField) quickfix.MessageRejectError {
	return m.Body.Get(f)
}
