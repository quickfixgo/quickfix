...
func (m Message) QuoteMsgID() (*field.QuoteMsgIDField, errors.MessageRejectError) {
...
func (m Message) GetQuoteMsgID(f *field.QuoteMsgIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}
