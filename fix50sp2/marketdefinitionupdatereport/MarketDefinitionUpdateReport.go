...
type Message struct {
	...
	//BaseTradingRules is a non-required component for MarketDefinitionUpdateReport.
	BaseTradingRules *basetradingrules.BaseTradingRules
	//OrdTypeRules is a non-required component for MarketDefinitionUpdateReport.
	OrdTypeRules *ordtyperules.OrdTypeRules
	//TimeInForceRules is a non-required component for MarketDefinitionUpdateReport.
	TimeInForceRules *timeinforcerules.TimeInForceRules
	//ExecInstRules is a non-required component for MarketDefinitionUpdateReport.
	...
	//ApplicationSequenceControl is a non-required component for MarketDefinitionUpdateReport.
...
//New returns an initialized MarketDefinitionUpdateReport instance
