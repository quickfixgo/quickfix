...
func (m Message) RejectText() (*field.RejectTextField, errors.MessageRejectError) {
...
func (m Message) GetRejectText(f *field.RejectTextField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m Message) CurrencyRatio() (*field.CurrencyRatioField, errors.MessageRejectError) {
...
func (m Message) GetCurrencyRatio(f *field.CurrencyRatioField) errors.MessageRejectError {
	return m.Body.Get(f)
}
