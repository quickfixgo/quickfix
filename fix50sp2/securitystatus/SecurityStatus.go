...
func (m Message) HaltReasonInt() (*field.HaltReasonIntField, quickfix.MessageRejectError) {
...
func (m Message) GetHaltReasonInt(f *field.HaltReasonIntField) quickfix.MessageRejectError {
	return m.Body.Get(f)
}
