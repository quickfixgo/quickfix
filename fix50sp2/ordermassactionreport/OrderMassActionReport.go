...
func (m Message) MassActionReportID() (*field.MassActionReportIDField, errors.MessageRejectError) {
...
func (m Message) GetMassActionReportID(f *field.MassActionReportIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m Message) MassActionResponse() (*field.MassActionResponseField, errors.MessageRejectError) {
...
func (m Message) GetMassActionResponse(f *field.MassActionResponseField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//MassActionRejectReason is a non-required field for OrderMassActionReport.
func (m Message) MassActionRejectReason() (*field.MassActionRejectReasonField, errors.MessageRejectError) {
...
func (m Message) GetMassActionRejectReason(f *field.MassActionRejectReasonField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m Message) NoNotAffectedOrders() (*field.NoNotAffectedOrdersField, errors.MessageRejectError) {
...
func (m Message) GetNoNotAffectedOrders(f *field.NoNotAffectedOrdersField) errors.MessageRejectError {
	return m.Body.Get(f)
}
