...
import (
	...
	"github.com/quickfixgo/quickfix/fix50sp2/legordgrp"
	...
	"github.com/quickfixgo/quickfix/fix50sp2/preallocmleggrp"
...
type Message struct {
	...
	Side string `fix:"54"`
	//Instrument is a non-required component for MultilegOrderCancelReplace.
	...
	//LegOrdGrp is a non-required component for MultilegOrderCancelReplace.
