...
func (m *PositionReport) ValuationMethod() (*field.ValuationMethod, error) {
...
func (m *PositionReport) OptPayoutType() (*field.OptPayoutType, error) {
...
func (m *PositionReport) ContractMultiplierUnit() (*field.ContractMultiplierUnit, error) {
...
func (m *PositionReport) UnderlyingPriceDeterminationMethod() (*field.UnderlyingPriceDeterminationMethod, error) {
...
func (m *PositionReport) PriceDelta() (*field.PriceDelta, error) {
...
func (m *PositionReport) OptPayoutAmount() (*field.OptPayoutAmount, error) {
	f := new(field.OptPayoutAmount)
	err := m.Body.Get(f)
	return f, err
}
func (m *PositionReport) NotionalPercentageOutstanding() (*field.NotionalPercentageOutstanding, error) {
...
func (m *PositionReport) NoComplexEvents() (*field.NoComplexEvents, error) {
...
func (m *PositionReport) AttachmentPoint() (*field.AttachmentPoint, error) {
...
func (m *PositionReport) StrikePriceDeterminationMethod() (*field.StrikePriceDeterminationMethod, error) {
...
func (m *PositionReport) RestructuringType() (*field.RestructuringType, error) {
...
func (m *PositionReport) FlowScheduleType() (*field.FlowScheduleType, error) {
	f := new(field.FlowScheduleType)
	err := m.Body.Get(f)
	return f, err
}
func (m *PositionReport) DetachmentPoint() (*field.DetachmentPoint, error) {
...
func (m *PositionReport) ModelType() (*field.ModelType, error) {
...
func (m *PositionReport) Seniority() (*field.Seniority, error) {
	f := new(field.Seniority)
	err := m.Body.Get(f)
	return f, err
}
func (m *PositionReport) StrikePriceBoundaryMethod() (*field.StrikePriceBoundaryMethod, error) {
...
func (m *PositionReport) OriginalNotionalPercentageOutstanding() (*field.OriginalNotionalPercentageOutstanding, error) {
...
func (m *PositionReport) StrikePriceBoundaryPrecision() (*field.StrikePriceBoundaryPrecision, error) {
