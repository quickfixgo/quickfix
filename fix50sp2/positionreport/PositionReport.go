...
import (
	...
	"github.com/quickfixgo/quickfix/fix50sp2/posundinstrmtgrp"
...
type Message struct {
	...
	//ApplicationSequenceControl is a non-required component for PositionReport.
...
func (m *Message) SetModelType(v int)      { m.ModelType = &v }
