...
type Message struct {
	...
	//PreAllocGrp is a non-required component for OrderCancelReplaceRequest.
	...
	//TrdgSesGrp is a non-required component for OrderCancelReplaceRequest.
	...
	//UndInstrmtGrp is a non-required component for OrderCancelReplaceRequest.
	...
	//StrategyParametersGrp is a non-required component for OrderCancelReplaceRequest.
	...
	//TrdRegTimestamps is a non-required component for OrderCancelReplaceRequest.
	...
	//DisplayInstruction is a non-required component for OrderCancelReplaceRequest.
	...
	//TriggeringInstruction is a non-required component for OrderCancelReplaceRequest.
...
func New(clordid string, instrument instrument.Instrument, side string, transacttime time.Time, orderqtydata orderqtydata.OrderQtyData, ordtype string) *Message {
	var m Message
