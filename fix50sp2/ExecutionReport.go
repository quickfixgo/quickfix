...
func (m ExecutionReport) OptPayoutAmount() (field.OptPayoutAmount, error) {
...
func (m ExecutionReport) ValuationMethod() (field.ValuationMethod, error) {
...
func (m ExecutionReport) ContractMultiplierUnit() (field.ContractMultiplierUnit, error) {
...
func (m ExecutionReport) FlowScheduleType() (field.FlowScheduleType, error) {
...
func (m ExecutionReport) RestructuringType() (field.RestructuringType, error) {
...
func (m ExecutionReport) Seniority() (field.Seniority, error) {
...
func (m ExecutionReport) NotionalPercentageOutstanding() (field.NotionalPercentageOutstanding, error) {
...
func (m ExecutionReport) OriginalNotionalPercentageOutstanding() (field.OriginalNotionalPercentageOutstanding, error) {
...
func (m ExecutionReport) AttachmentPoint() (field.AttachmentPoint, error) {
...
func (m ExecutionReport) DetachmentPoint() (field.DetachmentPoint, error) {
...
func (m ExecutionReport) StrikePriceDeterminationMethod() (field.StrikePriceDeterminationMethod, error) {
...
func (m ExecutionReport) StrikePriceBoundaryMethod() (field.StrikePriceBoundaryMethod, error) {
...
func (m ExecutionReport) StrikePriceBoundaryPrecision() (field.StrikePriceBoundaryPrecision, error) {
...
func (m ExecutionReport) UnderlyingPriceDeterminationMethod() (field.UnderlyingPriceDeterminationMethod, error) {
...
func (m ExecutionReport) OptPayoutType() (field.OptPayoutType, error) {
...
func (m ExecutionReport) NoComplexEvents() (field.NoComplexEvents, error) {
...
func (m ExecutionReport) NoRateSources() (field.NoRateSources, error) {
