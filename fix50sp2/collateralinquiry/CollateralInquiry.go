...
func (m CollateralInquiry) SetStrikeMultiplier(v float64) {
	m.Set(field.NewStrikeMultiplier(v))
}

//SetStrikeValue sets StrikeValue, Tag 968
func (m CollateralInquiry) SetStrikeValue(v float64) {
	m.Set(field.NewStrikeValue(v))
}

//SetMinPriceIncrement sets MinPriceIncrement, Tag 969
func (m CollateralInquiry) SetMinPriceIncrement(v float64) {
...
func (m CollateralInquiry) SetMinPriceIncrementAmount(v float64) {
	m.Set(field.NewMinPriceIncrementAmount(v))
}

//SetUnitOfMeasureQty sets UnitOfMeasureQty, Tag 1147
func (m CollateralInquiry) SetUnitOfMeasureQty(v float64) {
...
func (m CollateralInquiry) SetPriceUnitOfMeasureQty(v float64) {
...
func (m CollateralInquiry) SetOptPayoutAmount(v float64) {
...
func (m CollateralInquiry) SetCapPrice(v float64) {
	m.Set(field.NewCapPrice(v))
}

//SetFloorPrice sets FloorPrice, Tag 1200
func (m CollateralInquiry) SetFloorPrice(v float64) {
...
func (m CollateralInquiry) SetNotionalPercentageOutstanding(v float64) {
...
func (m CollateralInquiry) SetStrikePriceBoundaryPrecision(v float64) {
