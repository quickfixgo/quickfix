...
func (m AllocationInstruction) OptPayoutAmount() (field.OptPayoutAmount, error) {
...
func (m AllocationInstruction) ValuationMethod() (field.ValuationMethod, error) {
...
func (m AllocationInstruction) ContractMultiplierUnit() (field.ContractMultiplierUnit, error) {
...
func (m AllocationInstruction) FlowScheduleType() (field.FlowScheduleType, error) {
...
func (m AllocationInstruction) RestructuringType() (field.RestructuringType, error) {
...
func (m AllocationInstruction) Seniority() (field.Seniority, error) {
...
func (m AllocationInstruction) NotionalPercentageOutstanding() (field.NotionalPercentageOutstanding, error) {
...
func (m AllocationInstruction) OriginalNotionalPercentageOutstanding() (field.OriginalNotionalPercentageOutstanding, error) {
...
func (m AllocationInstruction) AttachmentPoint() (field.AttachmentPoint, error) {
...
func (m AllocationInstruction) DetachmentPoint() (field.DetachmentPoint, error) {
...
func (m AllocationInstruction) StrikePriceDeterminationMethod() (field.StrikePriceDeterminationMethod, error) {
...
func (m AllocationInstruction) StrikePriceBoundaryMethod() (field.StrikePriceBoundaryMethod, error) {
...
func (m AllocationInstruction) StrikePriceBoundaryPrecision() (field.StrikePriceBoundaryPrecision, error) {
...
func (m AllocationInstruction) UnderlyingPriceDeterminationMethod() (field.UnderlyingPriceDeterminationMethod, error) {
...
func (m AllocationInstruction) OptPayoutType() (field.OptPayoutType, error) {
...
func (m AllocationInstruction) NoComplexEvents() (field.NoComplexEvents, error) {
...
func (m AllocationInstruction) NoRateSources() (field.NoRateSources, error) {
