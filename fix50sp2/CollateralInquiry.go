...
func (m CollateralInquiry) SecurityGroup() (field.SecurityGroup, error) {
...
func (m CollateralInquiry) MinPriceIncrementAmount() (field.MinPriceIncrementAmount, error) {
...
func (m CollateralInquiry) UnitOfMeasureQty() (field.UnitOfMeasureQty, error) {
...
func (m CollateralInquiry) SecurityXMLLen() (field.SecurityXMLLen, error) {
...
func (m CollateralInquiry) SecurityXML() (field.SecurityXML, error) {
...
func (m CollateralInquiry) SecurityXMLSchema() (field.SecurityXMLSchema, error) {
...
func (m CollateralInquiry) ProductComplex() (field.ProductComplex, error) {
...
func (m CollateralInquiry) PriceUnitOfMeasure() (field.PriceUnitOfMeasure, error) {
...
func (m CollateralInquiry) PriceUnitOfMeasureQty() (field.PriceUnitOfMeasureQty, error) {
...
func (m CollateralInquiry) SettlMethod() (field.SettlMethod, error) {
...
func (m CollateralInquiry) ExerciseStyle() (field.ExerciseStyle, error) {
...
func (m CollateralInquiry) OptPayoutAmount() (field.OptPayoutAmount, error) {
...
func (m CollateralInquiry) PriceQuoteMethod() (field.PriceQuoteMethod, error) {
...
func (m CollateralInquiry) ListMethod() (field.ListMethod, error) {
...
func (m CollateralInquiry) CapPrice() (field.CapPrice, error) {
...
func (m CollateralInquiry) FloorPrice() (field.FloorPrice, error) {
...
func (m CollateralInquiry) PutOrCall() (field.PutOrCall, error) {
...
func (m CollateralInquiry) FlexibleIndicator() (field.FlexibleIndicator, error) {
...
func (m CollateralInquiry) FlexProductEligibilityIndicator() (field.FlexProductEligibilityIndicator, error) {
...
func (m CollateralInquiry) ValuationMethod() (field.ValuationMethod, error) {
...
func (m CollateralInquiry) ContractMultiplierUnit() (field.ContractMultiplierUnit, error) {
...
func (m CollateralInquiry) FlowScheduleType() (field.FlowScheduleType, error) {
...
func (m CollateralInquiry) RestructuringType() (field.RestructuringType, error) {
...
func (m CollateralInquiry) Seniority() (field.Seniority, error) {
...
func (m CollateralInquiry) NotionalPercentageOutstanding() (field.NotionalPercentageOutstanding, error) {
...
func (m CollateralInquiry) OriginalNotionalPercentageOutstanding() (field.OriginalNotionalPercentageOutstanding, error) {
...
func (m CollateralInquiry) AttachmentPoint() (field.AttachmentPoint, error) {
...
func (m CollateralInquiry) DetachmentPoint() (field.DetachmentPoint, error) {
...
func (m CollateralInquiry) StrikePriceDeterminationMethod() (field.StrikePriceDeterminationMethod, error) {
...
func (m CollateralInquiry) StrikePriceBoundaryMethod() (field.StrikePriceBoundaryMethod, error) {
...
func (m CollateralInquiry) StrikePriceBoundaryPrecision() (field.StrikePriceBoundaryPrecision, error) {
...
func (m CollateralInquiry) UnderlyingPriceDeterminationMethod() (field.UnderlyingPriceDeterminationMethod, error) {
...
func (m CollateralInquiry) OptPayoutType() (field.OptPayoutType, error) {
...
func (m CollateralInquiry) NoComplexEvents() (field.NoComplexEvents, error) {
