...
func (m *Component) SetLegContractMultiplierUnit(v int)           { m.LegContractMultiplierUnit = &v }
func (m *Component) SetLegFlowScheduleType(v int)                 { m.LegFlowScheduleType = &v }
