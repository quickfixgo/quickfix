...
type NoQuoteEntries struct {
	...
	//BookingType is a non-required field for NoQuoteEntries.
	BookingType *int `fix:"775"`
	//OrderCapacity is a non-required field for NoQuoteEntries.
	OrderCapacity *string `fix:"528"`
	//OrderRestrictions is a non-required field for NoQuoteEntries.
	OrderRestrictions *string `fix:"529"`
}

//Component is a fix50sp2 QuotEntryAckGrp Component
