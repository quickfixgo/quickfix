...
func (m *TradeCaptureReportAck) OptPayoutType() (*field.OptPayoutType, error) {
...
func (m *TradeCaptureReportAck) StrikePriceBoundaryMethod() (*field.StrikePriceBoundaryMethod, error) {
...
func (m *TradeCaptureReportAck) NotionalPercentageOutstanding() (*field.NotionalPercentageOutstanding, error) {
...
func (m *TradeCaptureReportAck) OriginalNotionalPercentageOutstanding() (*field.OriginalNotionalPercentageOutstanding, error) {
	f := new(field.OriginalNotionalPercentageOutstanding)
	err := m.Body.Get(f)
	return f, err
}
func (m *TradeCaptureReportAck) StrikePriceDeterminationMethod() (*field.StrikePriceDeterminationMethod, error) {
	f := new(field.StrikePriceDeterminationMethod)
	err := m.Body.Get(f)
	return f, err
}
func (m *TradeCaptureReportAck) DetachmentPoint() (*field.DetachmentPoint, error) {
	f := new(field.DetachmentPoint)
	err := m.Body.Get(f)
	return f, err
}
func (m *TradeCaptureReportAck) NoComplexEvents() (*field.NoComplexEvents, error) {
...
func (m *TradeCaptureReportAck) MarketID() (*field.MarketID, error) {
...
func (m *TradeCaptureReportAck) RestructuringType() (*field.RestructuringType, error) {
...
func (m *TradeCaptureReportAck) OptPayoutAmount() (*field.OptPayoutAmount, error) {
...
func (m *TradeCaptureReportAck) FlowScheduleType() (*field.FlowScheduleType, error) {
...
func (m *TradeCaptureReportAck) Seniority() (*field.Seniority, error) {
...
func (m *TradeCaptureReportAck) ValuationMethod() (*field.ValuationMethod, error) {
...
func (m *TradeCaptureReportAck) MarketSegmentID() (*field.MarketSegmentID, error) {
...
func (m *TradeCaptureReportAck) AttachmentPoint() (*field.AttachmentPoint, error) {
...
func (m *TradeCaptureReportAck) UnderlyingPriceDeterminationMethod() (*field.UnderlyingPriceDeterminationMethod, error) {
...
func (m *TradeCaptureReportAck) ContractMultiplierUnit() (*field.ContractMultiplierUnit, error) {
	f := new(field.ContractMultiplierUnit)
	err := m.Body.Get(f)
	return f, err
}
func (m *TradeCaptureReportAck) StrikePriceBoundaryPrecision() (*field.StrikePriceBoundaryPrecision, error) {
...
func (m *TradeCaptureReportAck) VenueType() (*field.VenueType, error) {
