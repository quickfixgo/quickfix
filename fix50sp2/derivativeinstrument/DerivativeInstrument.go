...
import (
	"github.com/quickfixgo/quickfix/fix50sp2/derivativeeventsgrp"
	"github.com/quickfixgo/quickfix/fix50sp2/derivativeinstrumentparties"
	"github.com/quickfixgo/quickfix/fix50sp2/derivativesecurityaltidgrp"
	"github.com/quickfixgo/quickfix/fix50sp2/derivativesecurityxml"
)

//DerivativeInstrument is a fix50sp2 Component
...
func (m *DerivativeInstrument) SetDerivativeValuationMethod(v string) {
...
func (m *DerivativeInstrument) SetDerivativeFlowScheduleType(v int) { m.DerivativeFlowScheduleType = &v }
