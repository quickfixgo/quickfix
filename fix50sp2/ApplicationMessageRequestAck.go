...
func (m ApplicationMessageRequestAck) NoPartyIDs() (*field.NoPartyIDsField, errors.MessageRejectError) {
...
func (m ApplicationMessageRequestAck) GetNoPartyIDs(f *field.NoPartyIDsField) errors.MessageRejectError {
	return m.Body.Get(f)
}
