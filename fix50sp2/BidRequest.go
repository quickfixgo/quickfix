...
func (m BidRequest) GetTotNoRelatedSym(f *field.TotNoRelatedSym) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m BidRequest) GetBidTradeType(f *field.BidTradeType) errors.MessageRejectError {
	return m.Body.Get(f)
}
