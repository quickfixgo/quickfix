...
import (
	"github.com/quickfixgo/quickfix/fix50sp2/nstdptys4subgrp"
)
...
//Component is a fix50sp2 NestedParties4 Component
...
func (m *Component) SetNoNested4PartyIDs(v []NoNested4PartyIDs) { m.NoNested4PartyIDs = v }
