...
func (m Message) RefApplVerID() (*field.RefApplVerIDField, errors.MessageRejectError) {
...
func (m Message) GetRefApplVerID(f *field.RefApplVerIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//RefApplExtID is a non-required field for BusinessMessageReject.
func (m Message) RefApplExtID() (*field.RefApplExtIDField, errors.MessageRejectError) {
...
func (m Message) GetRefApplExtID(f *field.RefApplExtIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//RefCstmApplVerID is a non-required field for BusinessMessageReject.
func (m Message) RefCstmApplVerID() (*field.RefCstmApplVerIDField, errors.MessageRejectError) {
...
func (m Message) GetRefCstmApplVerID(f *field.RefCstmApplVerIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}
