...
func (m SecurityDefinition) ExpirationCycle() (*field.ExpirationCycle, errors.MessageRejectError) {
...
func (m SecurityDefinition) GetExpirationCycle(f *field.ExpirationCycle) errors.MessageRejectError {
	return m.Body.Get(f)
}
