...
func (m Message) PosReqStatus() (*field.PosReqStatusField, errors.MessageRejectError) {
...
func (m Message) GetPosReqStatus(f *field.PosReqStatusField) errors.MessageRejectError {
	return m.Body.Get(f)
}
