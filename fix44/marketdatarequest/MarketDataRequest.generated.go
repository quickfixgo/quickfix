...
func (m NoRelatedSym) GetApplQueueAction() (f field.ApplQueueActionField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetApplQueueMax gets ApplQueueMax, Tag 812
func (m NoRelatedSym) GetApplQueueMax() (f field.ApplQueueMaxField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
