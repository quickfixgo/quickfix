...
func (m MassQuote) AcctIDSource() (*field.AcctIDSourceField, errors.MessageRejectError) {
...
func (m MassQuote) GetAcctIDSource(f *field.AcctIDSourceField) errors.MessageRejectError {
	return m.Body.Get(f)
}
