...
func (m SecurityDefinition) SetRoundLot(v float64) {
	m.Set(field.NewRoundLot(v))
}

//SetMinTradeVol sets MinTradeVol, Tag 562
func (m SecurityDefinition) SetMinTradeVol(v float64) {
	m.Set(field.NewMinTradeVol(v))
}

//SetTradingSessionSubID sets TradingSessionSubID, Tag 625
func (m SecurityDefinition) SetTradingSessionSubID(v string) {
...
func (m SecurityDefinition) SetExpirationCycle(v int) {
...
func (m SecurityDefinition) GetRoundLot() (f field.RoundLotField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetMinTradeVol gets MinTradeVol, Tag 562
func (m SecurityDefinition) GetMinTradeVol() (f field.MinTradeVolField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetTradingSessionSubID gets TradingSessionSubID, Tag 625
func (m SecurityDefinition) GetTradingSessionSubID() (f field.TradingSessionSubIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m SecurityDefinition) GetExpirationCycle() (f field.ExpirationCycleField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m ClearingBusinessDate) SetLegOptionRatio(v float64) {
	m.Set(field.NewLegOptionRatio(v))
}

//SetLegPrice sets LegPrice, Tag 566
func (m ClearingBusinessDate) SetLegPrice(v float64) {
	m.Set(field.NewLegPrice(v))
}

//GetLegOptionRatio gets LegOptionRatio, Tag 1017
func (m ClearingBusinessDate) GetLegOptionRatio() (f field.LegOptionRatioField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetLegPrice gets LegPrice, Tag 566
func (m ClearingBusinessDate) GetLegPrice() (f field.LegPriceField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
