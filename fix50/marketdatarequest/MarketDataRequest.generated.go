...
func (m MarketDataRequest) SetOpenCloseSettlFlag(v string) {
...
func (m MarketDataRequest) SetApplQueueAction(v int) {
	m.Set(field.NewApplQueueAction(v))
}

//SetMDQuoteType sets MDQuoteType, Tag 1070
func (m MarketDataRequest) SetMDQuoteType(v int) {
...
func (m MarketDataRequest) GetOpenCloseSettlFlag() (f field.OpenCloseSettlFlagField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m MarketDataRequest) GetApplQueueMax() (f field.ApplQueueMaxField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetApplQueueAction gets ApplQueueAction, Tag 815
func (m MarketDataRequest) GetApplQueueAction() (f field.ApplQueueActionField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetMDQuoteType gets MDQuoteType, Tag 1070
func (m MarketDataRequest) GetMDQuoteType() (f field.MDQuoteTypeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
