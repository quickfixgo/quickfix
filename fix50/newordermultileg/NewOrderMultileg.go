...
type Message struct {
	...
	//LegOrdGrp is a required component for NewOrderMultileg.
	legordgrp.LegOrdGrp
...
func New(clordid string, side string, instrument instrument.Instrument, legordgrp legordgrp.LegOrdGrp, transacttime time.Time, ordtype string) *Message {
	var m Message
...
func Route(router RouteOut) (string, string, quickfix.MessageRoute) {
	...
	return enum.BeginStringFIX50, "AB", r
}
