...
func (m SubscriptionRequestType) GetLegOptionRatio() (v decimal.Decimal, scale int32, err quickfix.MessageRejectError) {
...
func (m SubscriptionRequestType) GetLegPrice() (v decimal.Decimal, scale int32, err quickfix.MessageRejectError) {
