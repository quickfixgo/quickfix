...
func (m SubscriptionRequestType) SetLegOptionRatio(v float64) {
	m.Set(field.NewLegOptionRatio(v))
}

//SetLegPrice sets LegPrice, Tag 566
func (m SubscriptionRequestType) SetLegPrice(v float64) {
	m.Set(field.NewLegPrice(v))
}

//GetLegOptionRatio gets LegOptionRatio, Tag 1017
func (m SubscriptionRequestType) GetLegOptionRatio() (f field.LegOptionRatioField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetLegPrice gets LegPrice, Tag 566
func (m SubscriptionRequestType) GetLegPrice() (f field.LegPriceField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
