...
func (m SettlementInstructionRequest) SettlCurrency() (*field.SettlCurrencyField, errors.MessageRejectError) {
...
func (m SettlementInstructionRequest) GetSettlCurrency(f *field.SettlCurrencyField) errors.MessageRejectError {
	return m.Body.Get(f)
}
