...
func (m SecurityDefinition) ExpirationCycle() (*field.ExpirationCycleField, errors.MessageRejectError) {
...
func (m SecurityDefinition) GetExpirationCycle(f *field.ExpirationCycleField) errors.MessageRejectError {
	return m.Body.Get(f)
}
