...
import (
	"github.com/quickfixgo/quickfix/fix50/underlyingstipulations"
	"github.com/quickfixgo/quickfix/fix50/undlyinstrumentparties"
	"github.com/quickfixgo/quickfix/fix50/undsecaltidgrp"
)
...
type UnderlyingInstrument struct {
	...
	//UndlyInstrumentParties Component
