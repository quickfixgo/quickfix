...
func (m Message) ContIntRptID() (*field.ContIntRptIDField, errors.MessageRejectError) {
...
func (m Message) GetContIntRptID(f *field.ContIntRptIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m Message) LateIndicator() (*field.LateIndicatorField, errors.MessageRejectError) {
...
func (m Message) GetLateIndicator(f *field.LateIndicatorField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//InputSource is a non-required field for ContraryIntentionReport.
func (m Message) InputSource() (*field.InputSourceField, errors.MessageRejectError) {
...
func (m Message) GetInputSource(f *field.InputSourceField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m Message) NoExpiration() (*field.NoExpirationField, errors.MessageRejectError) {
...
func (m Message) GetNoExpiration(f *field.NoExpirationField) errors.MessageRejectError {
	return m.Body.Get(f)
}
