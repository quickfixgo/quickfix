	...
	return NoNested3PartySubIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.Nested3PartySubID),
				quickfix.GroupElement(tag.Nested3PartySubIDType),
			},
		),
	}
}
...
func NewNoNested3PartyIDsRepeatingGroup() NoNested3PartyIDsRepeatingGroup {
	return NoNested3PartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.Nested3PartyID),
				quickfix.GroupElement(tag.Nested3PartyIDSource),
				quickfix.GroupElement(tag.Nested3PartyRole),
				NewNoNested3PartySubIDsRepeatingGroup(),
			},
		),
	}
}
	...
	return NoAllocsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				NewNoNested3PartyIDsRepeatingGroup(),
...
func NewNoLegAllocsRepeatingGroup() NoLegAllocsRepeatingGroup {
	return NoLegAllocsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			tag.NoLegAllocs,
			quickfix.GroupTemplate{
				quickfix.GroupElement(tag.LegAllocAccount),
				quickfix.GroupElement(tag.LegIndividualAllocID),
				NewNoNested2PartyIDsRepeatingGroup(),
				quickfix.GroupElement(tag.LegAllocQty),
				quickfix.GroupElement(tag.LegAllocAcctIDSource),
