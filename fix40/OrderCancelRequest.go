...
func (m OrderCancelRequest) CxlType() (*field.CxlTypeField, errors.MessageRejectError) {
...
func (m OrderCancelRequest) GetCxlType(f *field.CxlTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}
