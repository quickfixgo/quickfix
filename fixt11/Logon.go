...
func (m Logon) DefaultApplVerID() (*field.DefaultApplVerIDField, errors.MessageRejectError) {
...
func (m Logon) GetDefaultApplVerID(f *field.DefaultApplVerIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}
