...
func (m Message) NextExpectedMsgSeqNum() (*field.NextExpectedMsgSeqNumField, errors.MessageRejectError) {
...
func (m Message) GetNextExpectedMsgSeqNum(f *field.NextExpectedMsgSeqNumField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m Message) DefaultApplVerID() (*field.DefaultApplVerIDField, errors.MessageRejectError) {
	f := &field.DefaultApplVerIDField{}
	err := m.Body.Get(f)
	return f, err
}

//GetDefaultApplVerID reads a DefaultApplVerID from Logon.
func (m Message) GetDefaultApplVerID(f *field.DefaultApplVerIDField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func Route(router RouteOut) (string, string, quickfix.MessageRoute) {
	...
	return fix.BeginString_FIXT11, "A", r
}
