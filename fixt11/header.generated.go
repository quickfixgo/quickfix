...
func (h Header) GetApplVerID() (f field.ApplVerIDField, err quickfix.MessageRejectError) {
	err = h.Get(&f)
	return
}

//GetCstmApplVerID gets CstmApplVerID, Tag 1129
func (h Header) GetCstmApplVerID() (f field.CstmApplVerIDField, err quickfix.MessageRejectError) {
	err = h.Get(&f)
	return
}
