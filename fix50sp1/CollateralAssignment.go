...
func (m *CollateralAssignment) OptPayAmount() (*field.OptPayAmount, error) {
...
func (m *CollateralAssignment) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
