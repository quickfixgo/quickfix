...
func (m CollateralAssignment) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m CollateralAssignment) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m CollateralAssignment) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m CollateralAssignment) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
