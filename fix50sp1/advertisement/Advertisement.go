...
func (m Advertisement) SetOptPayAmount(v float64) {
...
func (m Advertisement) SetFuturesValuationMethod(v string) {
...
func (m Advertisement) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m Advertisement) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
