...
func (m CollateralResponse) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m CollateralResponse) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m CollateralResponse) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m CollateralResponse) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
