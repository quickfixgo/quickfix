...
func (m QuoteStatusReport) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m QuoteStatusReport) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m QuoteStatusReport) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m QuoteStatusReport) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
