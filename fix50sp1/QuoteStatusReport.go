...
func NewQuoteStatusReportBuilder() *QuoteStatusReportBuilder {
...
func (m *QuoteStatusReport) OptPayAmount() (*field.OptPayAmount, error) {
...
func (m *QuoteStatusReport) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
