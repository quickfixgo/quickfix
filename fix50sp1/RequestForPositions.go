...
func (m RequestForPositions) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m RequestForPositions) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m RequestForPositions) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m RequestForPositions) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
