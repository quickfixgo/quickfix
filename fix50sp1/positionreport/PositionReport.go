...
func (m PositionReport) SetOptPayAmount(v float64) {
...
func (m PositionReport) SetFuturesValuationMethod(v string) {
...
func (m PositionReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m PositionReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
