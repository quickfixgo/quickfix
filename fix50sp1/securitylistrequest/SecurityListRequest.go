...
func (m SecurityListRequest) SetOptPayAmount(v float64) {
...
func (m SecurityListRequest) SetFuturesValuationMethod(v string) {
...
func (m SecurityListRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m SecurityListRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
