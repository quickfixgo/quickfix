...
func (m *RequestForPositionsAck) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
...
func (m *RequestForPositionsAck) OptPayAmount() (*field.OptPayAmount, error) {
