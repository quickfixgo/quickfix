...
func (m DerivativeSecurityListUpdateReport) GetDerivativeFuturesValuationMethod() (f field.DerivativeFuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
