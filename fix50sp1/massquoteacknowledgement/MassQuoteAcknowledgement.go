...
func (m MassQuoteAcknowledgement) SetQuoteType(v int) {
	m.Set(field.NewQuoteType(v))
}

//SetAccountType sets AccountType, Tag 581
func (m MassQuoteAcknowledgement) SetAccountType(v int) {
	m.Set(field.NewAccountType(v))
}

//SetAcctIDSource sets AcctIDSource, Tag 660
func (m MassQuoteAcknowledgement) SetAcctIDSource(v int) {
	m.Set(field.NewAcctIDSource(v))
}

//GetAccount gets Account, Tag 1
func (m MassQuoteAcknowledgement) GetAccount() (f field.AccountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetText gets Text, Tag 58
func (m MassQuoteAcknowledgement) GetText() (f field.TextField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteID gets QuoteID, Tag 117
func (m MassQuoteAcknowledgement) GetQuoteID() (f field.QuoteIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteReqID gets QuoteReqID, Tag 131
func (m MassQuoteAcknowledgement) GetQuoteReqID() (f field.QuoteReqIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m MassQuoteAcknowledgement) GetQuoteStatus() (f field.QuoteStatusField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteCancelType gets QuoteCancelType, Tag 298
func (m MassQuoteAcknowledgement) GetQuoteCancelType() (f field.QuoteCancelTypeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteRejectReason gets QuoteRejectReason, Tag 300
func (m MassQuoteAcknowledgement) GetQuoteRejectReason() (f field.QuoteRejectReasonField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteResponseLevel gets QuoteResponseLevel, Tag 301
func (m MassQuoteAcknowledgement) GetQuoteResponseLevel() (f field.QuoteResponseLevelField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetEncodedTextLen gets EncodedTextLen, Tag 354
func (m MassQuoteAcknowledgement) GetEncodedTextLen() (f field.EncodedTextLenField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetEncodedText gets EncodedText, Tag 355
func (m MassQuoteAcknowledgement) GetEncodedText() (f field.EncodedTextField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m MassQuoteAcknowledgement) GetQuoteType() (f field.QuoteTypeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetAccountType gets AccountType, Tag 581
func (m MassQuoteAcknowledgement) GetAccountType() (f field.AccountTypeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetAcctIDSource gets AcctIDSource, Tag 660
func (m MassQuoteAcknowledgement) GetAcctIDSource() (f field.AcctIDSourceField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NoQuoteSets) GetTotNoCxldQuotes() (f field.TotNoCxldQuotesField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetTotNoAccQuotes gets TotNoAccQuotes, Tag 1169
func (m NoQuoteSets) GetTotNoAccQuotes() (f field.TotNoAccQuotesField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetTotNoRejQuotes gets TotNoRejQuotes, Tag 1170
func (m NoQuoteSets) GetTotNoRejQuotes() (f field.TotNoRejQuotesField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NoQuoteEntries) SetOptPayAmount(v float64) {
...
func (m NoQuoteEntries) SetQuoteEntryStatus(v int) {
...
func (m NoQuoteEntries) GetQuoteEntryRejectReason() (f field.QuoteEntryRejectReasonField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteEntryStatus gets QuoteEntryStatus, Tag 1167
func (m NoQuoteEntries) GetQuoteEntryStatus() (f field.QuoteEntryStatusField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
