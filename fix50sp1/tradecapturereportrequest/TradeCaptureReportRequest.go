...
func (m TradeCaptureReportRequest) SetOptPayAmount(v float64) {
...
func (m TradeCaptureReportRequest) SetFuturesValuationMethod(v string) {
...
func (m TradeCaptureReportRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m TradeCaptureReportRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
