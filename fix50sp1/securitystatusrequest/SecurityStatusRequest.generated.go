...
func (m SecurityStatusRequest) SetOptPayAmount(v float64) {
...
func (m SecurityStatusRequest) SetFuturesValuationMethod(v string) {
...
func (m SecurityStatusRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m SecurityStatusRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
