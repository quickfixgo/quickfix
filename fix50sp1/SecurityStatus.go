...
func (m SecurityStatus) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m SecurityStatus) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m SecurityStatus) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m SecurityStatus) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
