...
func (m *TradingSessionStatus) OptPayAmount() (*field.OptPayAmount, error) {
	f := new(field.OptPayAmount)
	err := m.Body.Get(f)
	return f, err
}
func (m *TradingSessionStatus) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
