...
func (m TradingSessionStatus) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m TradingSessionStatus) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m TradingSessionStatus) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m TradingSessionStatus) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
