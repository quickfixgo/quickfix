...
func (m AllocationReport) SetOptPayAmount(v float64) {
...
func (m AllocationReport) SetFuturesValuationMethod(v string) {
...
func (m AllocationReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m AllocationReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
