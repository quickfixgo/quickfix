...
func (m NewOrderSingle) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m NewOrderSingle) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m NewOrderSingle) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m NewOrderSingle) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
