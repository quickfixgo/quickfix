...
func (m CollateralAssignment) SetOptPayAmount(v float64) {
...
func (m CollateralAssignment) SetFuturesValuationMethod(v string) {
...
func (m CollateralAssignment) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m CollateralAssignment) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
