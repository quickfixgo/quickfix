...
func (m AllocationInstruction) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m AllocationInstruction) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m AllocationInstruction) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m AllocationInstruction) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
