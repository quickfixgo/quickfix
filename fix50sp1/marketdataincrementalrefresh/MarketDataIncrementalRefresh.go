...
func (m NoMDEntries) SetOptPayAmount(v float64) {
...
func (m NoMDEntries) SetFuturesValuationMethod(v string) {
...
func (m NoMDEntries) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NoMDEntries) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
