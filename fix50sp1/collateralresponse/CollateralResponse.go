...
func (m CollateralResponse) SetOptPayAmount(v float64) {
...
func (m CollateralResponse) SetFuturesValuationMethod(v string) {
...
func (m CollateralResponse) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m CollateralResponse) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
