...
func (m PositionMaintenanceReport) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m PositionMaintenanceReport) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m PositionMaintenanceReport) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m PositionMaintenanceReport) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
