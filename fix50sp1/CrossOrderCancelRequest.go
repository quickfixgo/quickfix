...
func (m CrossOrderCancelRequest) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m CrossOrderCancelRequest) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
