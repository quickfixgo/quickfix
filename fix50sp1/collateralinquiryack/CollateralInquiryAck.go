...
func (m Message) CollInquiryStatus() (*field.CollInquiryStatusField, errors.MessageRejectError) {
...
func (m Message) GetCollInquiryStatus(f *field.CollInquiryStatusField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//CollInquiryResult is a non-required field for CollateralInquiryAck.
func (m Message) CollInquiryResult() (*field.CollInquiryResultField, errors.MessageRejectError) {
...
func (m Message) GetCollInquiryResult(f *field.CollInquiryResultField) errors.MessageRejectError {
	return m.Body.Get(f)
}
