...
func (m CollateralInquiryAck) SetOptPayAmount(v float64) {
...
func (m CollateralInquiryAck) SetFuturesValuationMethod(v string) {
...
func (m CollateralInquiryAck) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m CollateralInquiryAck) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
