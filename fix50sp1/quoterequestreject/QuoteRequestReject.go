...
func (m QuoteRequestReject) SetQuoteRequestRejectReason(v int) {
...
func (m QuoteRequestReject) SetRespondentType(v int) {
	m.Set(field.NewRespondentType(v))
}

//GetText gets Text, Tag 58
func (m QuoteRequestReject) GetText() (f field.TextField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteReqID gets QuoteReqID, Tag 131
func (m QuoteRequestReject) GetQuoteReqID() (f field.QuoteReqIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m QuoteRequestReject) GetEncodedTextLen() (f field.EncodedTextLenField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetEncodedText gets EncodedText, Tag 355
func (m QuoteRequestReject) GetEncodedText() (f field.EncodedTextField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetRFQReqID gets RFQReqID, Tag 644
func (m QuoteRequestReject) GetRFQReqID() (f field.RFQReqIDField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetQuoteRequestRejectReason gets QuoteRequestRejectReason, Tag 658
func (m QuoteRequestReject) GetQuoteRequestRejectReason() (f field.QuoteRequestRejectReasonField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetPreTradeAnonymity gets PreTradeAnonymity, Tag 1091
func (m QuoteRequestReject) GetPreTradeAnonymity() (f field.PreTradeAnonymityField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m QuoteRequestReject) GetPrivateQuote() (f field.PrivateQuoteField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}

//GetRespondentType gets RespondentType, Tag 1172
func (m QuoteRequestReject) GetRespondentType() (f field.RespondentTypeField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
