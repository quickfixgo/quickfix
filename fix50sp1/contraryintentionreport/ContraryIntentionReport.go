...
func (m ContraryIntentionReport) SetOptPayAmount(v float64) {
...
func (m ContraryIntentionReport) SetFuturesValuationMethod(v string) {
...
func (m ContraryIntentionReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m ContraryIntentionReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
