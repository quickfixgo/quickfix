...
func (m SecurityDefinitionRequest) SetOptPayAmount(v float64) {
...
func (m SecurityDefinitionRequest) SetFuturesValuationMethod(v string) {
...
func (m SecurityDefinitionRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m SecurityDefinitionRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
