...
func (m AssignmentReport) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m AssignmentReport) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m AssignmentReport) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m AssignmentReport) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
