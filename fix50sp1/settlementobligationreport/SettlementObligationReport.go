...
//New returns an initialized MessageBuilder with specified required fields for SettlementObligationReport.
func New(
	settlobligmsgid *field.SettlObligMsgIDField,
	settlobligmode *field.SettlObligModeField) Message {
