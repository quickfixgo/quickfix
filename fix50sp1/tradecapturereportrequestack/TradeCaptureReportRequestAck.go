...
func (m TradeCaptureReportRequestAck) SetOptPayAmount(v float64) {
...
func (m TradeCaptureReportRequestAck) SetFuturesValuationMethod(v string) {
...
func (m TradeCaptureReportRequestAck) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m TradeCaptureReportRequestAck) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
