...
func (m OrderMassCancelRequest) OptPayAmount() (field.OptPayAmount, error) {
...
func (m OrderMassCancelRequest) FuturesValuationMethod() (field.FuturesValuationMethod, error) {
