...
func (m OrderMassCancelRequest) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m OrderMassCancelRequest) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m OrderMassCancelRequest) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m OrderMassCancelRequest) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
