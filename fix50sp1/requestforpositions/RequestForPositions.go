...
func (m RequestForPositions) SetOptPayAmount(v float64) {
...
func (m RequestForPositions) SetFuturesValuationMethod(v string) {
...
func (m RequestForPositions) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m RequestForPositions) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
