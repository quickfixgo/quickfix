...
//Message is a RequestForPositions wrapper for the generic Message type
type Message struct {
	quickfix.Message
}
...
//New returns an initialized Message with specified required fields for RequestForPositions.
func New(
