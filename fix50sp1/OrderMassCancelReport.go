...
func (m OrderMassCancelReport) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m OrderMassCancelReport) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m OrderMassCancelReport) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m OrderMassCancelReport) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
