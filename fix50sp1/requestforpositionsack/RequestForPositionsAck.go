...
func (m RequestForPositionsAck) SetOptPayAmount(v float64) {
...
func (m RequestForPositionsAck) SetFuturesValuationMethod(v string) {
...
func (m RequestForPositionsAck) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m RequestForPositionsAck) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
