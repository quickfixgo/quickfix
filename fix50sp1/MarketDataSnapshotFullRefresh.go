...
func (m MarketDataSnapshotFullRefresh) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m MarketDataSnapshotFullRefresh) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
