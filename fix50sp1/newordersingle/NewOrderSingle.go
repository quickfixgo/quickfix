...
func (m NewOrderSingle) SetOptPayAmount(v float64) {
...
func (m NewOrderSingle) SetFuturesValuationMethod(v string) {
...
func (m NewOrderSingle) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NewOrderSingle) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
