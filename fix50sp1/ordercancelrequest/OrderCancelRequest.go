...
func (m OrderCancelRequest) SetOptPayAmount(v float64) {
...
func (m OrderCancelRequest) SetFuturesValuationMethod(v string) {
...
func (m OrderCancelRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m OrderCancelRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
