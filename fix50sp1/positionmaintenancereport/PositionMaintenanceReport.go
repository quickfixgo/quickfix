...
func (m Message) PosMaintStatus() (*field.PosMaintStatusField, errors.MessageRejectError) {
...
func (m Message) GetPosMaintStatus(f *field.PosMaintStatusField) errors.MessageRejectError {
	return m.Body.Get(f)
}

//PosMaintResult is a non-required field for PositionMaintenanceReport.
func (m Message) PosMaintResult() (*field.PosMaintResultField, errors.MessageRejectError) {
...
func (m Message) GetPosMaintResult(f *field.PosMaintResultField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func Route(router RouteOut) (string, string, quickfix.MessageRoute) {
	...
	return enum.ApplVerID_FIX50SP1, "AM", r
}
