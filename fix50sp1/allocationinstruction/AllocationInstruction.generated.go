...
func (m AllocationInstruction) SetOptPayAmount(v float64) {
...
func (m AllocationInstruction) SetFuturesValuationMethod(v string) {
...
func (m AllocationInstruction) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m AllocationInstruction) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
