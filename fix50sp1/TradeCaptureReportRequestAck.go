...
func (m TradeCaptureReportRequestAck) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m TradeCaptureReportRequestAck) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m TradeCaptureReportRequestAck) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m TradeCaptureReportRequestAck) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
