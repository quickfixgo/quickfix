...
func (m *TradeCaptureReportRequestAck) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
...
func (m *TradeCaptureReportRequestAck) OptPayAmount() (*field.OptPayAmount, error) {
