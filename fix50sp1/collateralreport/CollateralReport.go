...
func (m CollateralReport) SetOptPayAmount(v float64) {
...
func (m CollateralReport) SetFuturesValuationMethod(v string) {
...
func (m CollateralReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m CollateralReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
