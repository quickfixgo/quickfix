...
func (m AllocationInstructionAlert) SetOptPayAmount(v float64) {
...
func (m AllocationInstructionAlert) SetFuturesValuationMethod(v string) {
...
func (m AllocationInstructionAlert) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m AllocationInstructionAlert) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
