...
func (m ExecutionAcknowledgement) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m ExecutionAcknowledgement) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m ExecutionAcknowledgement) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m ExecutionAcknowledgement) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
