...
func (m ExecutionAcknowledgement) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m ExecutionAcknowledgement) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m ExecutionAcknowledgement) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m ExecutionAcknowledgement) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
