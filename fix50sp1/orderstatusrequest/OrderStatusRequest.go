...
func (m OrderStatusRequest) SetOptPayAmount(v float64) {
...
func (m OrderStatusRequest) SetFuturesValuationMethod(v string) {
...
func (m OrderStatusRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m OrderStatusRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
