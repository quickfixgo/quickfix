...
func (m CrossOrderCancelReplaceRequest) SetOptPayAmount(v float64) {
...
func (m CrossOrderCancelReplaceRequest) SetFuturesValuationMethod(v string) {
...
func (m CrossOrderCancelReplaceRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m CrossOrderCancelReplaceRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
