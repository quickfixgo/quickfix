...
func (m CollateralInquiryAck) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m CollateralInquiryAck) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m CollateralInquiryAck) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m CollateralInquiryAck) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
