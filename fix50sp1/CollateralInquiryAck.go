...
func (m CollateralInquiryAck) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m CollateralInquiryAck) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m CollateralInquiryAck) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m CollateralInquiryAck) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
