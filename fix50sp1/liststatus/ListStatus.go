...
func (m Message) ListRejectReason() (*field.ListRejectReasonField, errors.MessageRejectError) {
...
func (m Message) GetListRejectReason(f *field.ListRejectReasonField) errors.MessageRejectError {
	return m.Body.Get(f)
}
