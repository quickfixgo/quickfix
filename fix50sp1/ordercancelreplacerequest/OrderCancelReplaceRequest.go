...
func (m OrderCancelReplaceRequest) SetOptPayAmount(v float64) {
...
func (m OrderCancelReplaceRequest) SetFuturesValuationMethod(v string) {
...
func (m OrderCancelReplaceRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m OrderCancelReplaceRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
