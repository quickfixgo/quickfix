...
func (m IOI) SetOptPayAmount(v float64) {
...
func (m IOI) SetFuturesValuationMethod(v string) {
...
func (m IOI) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m IOI) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
