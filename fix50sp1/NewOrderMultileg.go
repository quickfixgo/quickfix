...
func (m NewOrderMultileg) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m NewOrderMultileg) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m NewOrderMultileg) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m NewOrderMultileg) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
