...
func (m NoStrikes) SetOptPayAmount(v float64) {
...
func (m NoStrikes) SetFuturesValuationMethod(v string) {
...
func (m NoStrikes) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NoStrikes) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
