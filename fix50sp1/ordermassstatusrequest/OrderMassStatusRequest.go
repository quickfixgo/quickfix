...
func (m Message) MassStatusReqType() (*field.MassStatusReqTypeField, errors.MessageRejectError) {
...
func (m Message) GetMassStatusReqType(f *field.MassStatusReqTypeField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func Route(router RouteOut) (string, string, quickfix.MessageRoute) {
	...
	return enum.ApplVerID_FIX50SP1, "AF", r
}
