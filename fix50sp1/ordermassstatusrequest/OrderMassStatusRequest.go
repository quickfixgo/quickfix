...
func (m OrderMassStatusRequest) SetOptPayAmount(v float64) {
...
func (m OrderMassStatusRequest) SetFuturesValuationMethod(v string) {
...
func (m OrderMassStatusRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m OrderMassStatusRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
