...
func (m MarketDataRequestReject) NoPartyIDs() (*field.NoPartyIDsField, errors.MessageRejectError) {
...
func (m MarketDataRequestReject) GetNoPartyIDs(f *field.NoPartyIDsField) errors.MessageRejectError {
	return m.Body.Get(f)
}
