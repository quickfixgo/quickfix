...
func (m MarketDataRequestReject) NoPartyIDs() (*field.NoPartyIDs, errors.MessageRejectError) {
...
func (m MarketDataRequestReject) GetNoPartyIDs(f *field.NoPartyIDs) errors.MessageRejectError {
	return m.Body.Get(f)
}
