...
func (m MarketDataSnapshotFullRefresh) SetOptPayAmount(v float64) {
...
func (m MarketDataSnapshotFullRefresh) SetFuturesValuationMethod(v string) {
...
func (m MarketDataSnapshotFullRefresh) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m MarketDataSnapshotFullRefresh) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NoMDEntries) SetHaltReasonChar(v string) {
...
func (m NoMDEntries) GetHaltReasonChar() (f field.HaltReasonCharField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
