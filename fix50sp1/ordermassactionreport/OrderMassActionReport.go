...
func (m OrderMassActionReport) SetOptPayAmount(v float64) {
...
func (m OrderMassActionReport) SetFuturesValuationMethod(v string) {
...
func (m OrderMassActionReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m OrderMassActionReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
