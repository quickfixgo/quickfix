...
func (m *OrderCancelReplaceRequest) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
...
func (m *OrderCancelReplaceRequest) OptPayAmount() (*field.OptPayAmount, error) {
