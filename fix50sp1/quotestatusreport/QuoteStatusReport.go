...
func (m QuoteStatusReport) SetOptPayAmount(v float64) {
...
func (m QuoteStatusReport) SetFuturesValuationMethod(v string) {
...
func (m QuoteStatusReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m QuoteStatusReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
