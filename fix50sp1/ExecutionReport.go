...
func (m ExecutionReport) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m ExecutionReport) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m ExecutionReport) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m ExecutionReport) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
