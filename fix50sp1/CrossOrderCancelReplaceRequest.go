...
func (m CrossOrderCancelReplaceRequest) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m CrossOrderCancelReplaceRequest) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m CrossOrderCancelReplaceRequest) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m CrossOrderCancelReplaceRequest) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
