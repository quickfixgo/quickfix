...
func (m *CrossOrderCancelReplaceRequest) OptPayAmount() (*field.OptPayAmount, error) {
...
func (m *CrossOrderCancelReplaceRequest) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
