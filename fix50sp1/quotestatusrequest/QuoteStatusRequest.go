...
func (m QuoteStatusRequest) SetOptPayAmount(v float64) {
...
func (m QuoteStatusRequest) SetFuturesValuationMethod(v string) {
...
func (m QuoteStatusRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m QuoteStatusRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
