...
func (m MultilegOrderCancelReplace) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m MultilegOrderCancelReplace) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m MultilegOrderCancelReplace) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m MultilegOrderCancelReplace) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
