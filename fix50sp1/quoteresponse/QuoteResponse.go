...
func (m QuoteResponse) SetOptPayAmount(v float64) {
...
func (m QuoteResponse) SetFuturesValuationMethod(v string) {
...
func (m QuoteResponse) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m QuoteResponse) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
