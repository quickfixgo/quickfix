...
func (m AllocationInstructionAlert) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m AllocationInstructionAlert) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m AllocationInstructionAlert) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
