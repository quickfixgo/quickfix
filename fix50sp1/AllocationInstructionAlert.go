...
//GetOptPayAmount reads a OptPayAmount from AllocationInstructionAlert.
func (m AllocationInstructionAlert) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
//GetFuturesValuationMethod reads a FuturesValuationMethod from AllocationInstructionAlert.
func (m AllocationInstructionAlert) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
