...
func (m TradeCaptureReport) SetOptPayAmount(v float64) {
...
func (m TradeCaptureReport) SetFuturesValuationMethod(v string) {
...
func (m TradeCaptureReport) GetOrderCategory() (f field.OrderCategoryField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m TradeCaptureReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m TradeCaptureReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
