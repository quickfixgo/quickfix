...
func (m SecurityStatusRequest) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m SecurityStatusRequest) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m SecurityStatusRequest) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m SecurityStatusRequest) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
