...
func (m *SecurityStatusRequest) OptPayAmount() (*field.OptPayAmount, error) {
...
func (m *SecurityStatusRequest) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
