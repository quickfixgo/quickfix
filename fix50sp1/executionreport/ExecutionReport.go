...
func (m ExecutionReport) SetOptPayAmount(v float64) {
...
func (m ExecutionReport) SetFuturesValuationMethod(v string) {
...
func (m ExecutionReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m ExecutionReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func NewNoNested4PartyIDsRepeatingGroup() NoNested4PartyIDsRepeatingGroup {
	return NoNested4PartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(tag.NoNested4PartyIDs,
			quickfix.GroupTemplate{quickfix.GroupElement(tag.Nested4PartyID), quickfix.GroupElement(tag.Nested4PartyIDSource), quickfix.GroupElement(tag.Nested4PartyRole), quickfix.GroupElement(tag.NoNested4PartySubIDs)})}
}
...
func NewNoFillsRepeatingGroup() NoFillsRepeatingGroup {
	return NoFillsRepeatingGroup{
		quickfix.NewRepeatingGroup(tag.NoFills,
			quickfix.GroupTemplate{quickfix.GroupElement(tag.FillExecID), quickfix.GroupElement(tag.FillPx), quickfix.GroupElement(tag.FillQty), quickfix.GroupElement(tag.NoNested4PartyIDs)})}
}
