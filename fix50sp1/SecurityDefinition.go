...
func (m SecurityDefinition) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m SecurityDefinition) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m SecurityDefinition) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m SecurityDefinition) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
