...
func (m CollateralInquiry) SetOptPayAmount(v float64) {
...
func (m CollateralInquiry) SetFuturesValuationMethod(v string) {
...
func (m CollateralInquiry) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m CollateralInquiry) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
