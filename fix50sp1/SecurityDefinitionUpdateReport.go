...
func (m *SecurityDefinitionUpdateReport) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
...
func (m *SecurityDefinitionUpdateReport) OptPayAmount() (*field.OptPayAmount, error) {
