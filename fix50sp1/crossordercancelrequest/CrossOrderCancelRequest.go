...
func (m CrossOrderCancelRequest) SetOptPayAmount(v float64) {
...
func (m CrossOrderCancelRequest) SetFuturesValuationMethod(v string) {
...
func (m CrossOrderCancelRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m CrossOrderCancelRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
