...
func (m NewOrderCross) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m NewOrderCross) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m NewOrderCross) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m NewOrderCross) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
