...
func (m NewOrderCross) SetOptPayAmount(v float64) {
...
func (m NewOrderCross) SetFuturesValuationMethod(v string) {
...
func (m NewOrderCross) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m NewOrderCross) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
