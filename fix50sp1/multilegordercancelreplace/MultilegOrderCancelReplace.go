...
func (m MultilegOrderCancelReplace) SetOptPayAmount(v float64) {
...
func (m MultilegOrderCancelReplace) SetFuturesValuationMethod(v string) {
...
func (m MultilegOrderCancelReplace) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m MultilegOrderCancelReplace) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
