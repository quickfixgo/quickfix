...
func (m TradingSessionListUpdateReport) TradSesUpdateAction() (*field.TradSesUpdateActionField, errors.MessageRejectError) {
...
func (m TradingSessionListUpdateReport) GetTradSesUpdateAction(f *field.TradSesUpdateActionField) errors.MessageRejectError {
	return m.Body.Get(f)
}
