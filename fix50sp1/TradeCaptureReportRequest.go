...
func (m *TradeCaptureReportRequest) FuturesValuationMethod() (*field.FuturesValuationMethod, error) {
...
func (m *TradeCaptureReportRequest) OptPayAmount() (*field.OptPayAmount, error) {
