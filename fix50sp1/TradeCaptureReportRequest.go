...
func (m TradeCaptureReportRequest) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m TradeCaptureReportRequest) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m TradeCaptureReportRequest) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m TradeCaptureReportRequest) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
