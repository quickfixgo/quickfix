...
type Message struct {
	...
	//ApplicationSequenceControl is a non-required component for AssignmentReport.
...
func New(asgnrptid string, parties parties.Parties, clearingbusinessdate string) *Message {
	var m Message
