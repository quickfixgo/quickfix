...
func (m AssignmentReport) SetOptPayAmount(v float64) {
...
func (m AssignmentReport) SetFuturesValuationMethod(v string) {
...
func (m AssignmentReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m AssignmentReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
