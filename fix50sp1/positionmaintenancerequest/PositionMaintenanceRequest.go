...
func (m PositionMaintenanceRequest) SetOptPayAmount(v float64) {
...
func (m PositionMaintenanceRequest) SetFuturesValuationMethod(v string) {
...
func (m PositionMaintenanceRequest) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m PositionMaintenanceRequest) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
