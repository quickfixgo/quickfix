...
func (m Quote) SetOptPayAmount(v float64) {
...
func (m Quote) SetFuturesValuationMethod(v string) {
...
func (m Quote) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m Quote) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
