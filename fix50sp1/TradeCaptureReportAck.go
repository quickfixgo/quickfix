...
func (m TradeCaptureReportAck) OptPayAmount() (*field.OptPayAmount, errors.MessageRejectError) {
...
func (m TradeCaptureReportAck) GetOptPayAmount(f *field.OptPayAmount) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m TradeCaptureReportAck) FuturesValuationMethod() (*field.FuturesValuationMethod, errors.MessageRejectError) {
...
func (m TradeCaptureReportAck) GetFuturesValuationMethod(f *field.FuturesValuationMethod) errors.MessageRejectError {
	return m.Body.Get(f)
}
