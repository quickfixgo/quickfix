...
func (m QuoteStatusRequest) OptPayAmount() (*field.OptPayAmountField, errors.MessageRejectError) {
...
func (m QuoteStatusRequest) GetOptPayAmount(f *field.OptPayAmountField) errors.MessageRejectError {
	return m.Body.Get(f)
}
...
func (m QuoteStatusRequest) FuturesValuationMethod() (*field.FuturesValuationMethodField, errors.MessageRejectError) {
...
func (m QuoteStatusRequest) GetFuturesValuationMethod(f *field.FuturesValuationMethodField) errors.MessageRejectError {
	return m.Body.Get(f)
}
