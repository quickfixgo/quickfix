...
func (m OrderMassCancelReport) SetOptPayAmount(v float64) {
...
func (m OrderMassCancelReport) SetFuturesValuationMethod(v string) {
...
func (m OrderMassCancelReport) GetOptPayAmount() (f field.OptPayAmountField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
...
func (m OrderMassCancelReport) GetFuturesValuationMethod() (f field.FuturesValuationMethodField, err quickfix.MessageRejectError) {
	err = m.Get(&f)
	return
}
